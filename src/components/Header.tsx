...
import { workouts, FTP_TARGET } from '@/data/workouts';
...
export default function Header() {
  ...
  const progressToTarget = Math.round(((currentFtp - 220) / (FTP_TARGET - 220)) * 100);
      ...
      <div className="max-w-4xl mx-auto px-4 py-4">
        <div className="flex items-center justify-between mb-3">
          <div>
            ...
            <p className="text-sm text-gray-500">12 Hafta 250W+ Planı</p>
          </div>
          <button
        ...
        <div className="grid grid-cols-3 gap-3 mb-3">
          <div className="bg-gray-50 rounded-lg p-3 text-center">
            ...
            <div className="text-xs text-gray-500">Güncel FTP</div>
          </div>
          <div className="bg-gray-50 rounded-lg p-3 text-center">
            <div className="text-2xl font-bold text-green-600">{FTP_TARGET}W</div>
        ...
        <div className="space-y-2">
          <div>
            <div className="flex justify-between text-xs text-gray-600 mb-1">
              <span>Antrenman İlerlemesi</span>
              <span>{progress}%</span>
            </div>
          ...
          <div>
            <div className="flex justify-between text-xs text-gray-600 mb-1">
              <span>FTP Hedefi ({currentFtp}W → {FTP_TARGET}W)</span>
